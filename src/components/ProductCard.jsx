  ...
  return (
    <div className="group relative rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-2xl transition-all duration-500">
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Hover CTA */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 translate-y-6 group-hover:translate-y-0 transition-all duration-500 flex gap-2">

          <button
            onClick={handleAdd}
            disabled={product.stock === 0}
            className={`px-4 py-2 text-sm rounded-full backdrop-blur bg-white/90 text-black font-medium shadow-lg transition
              ${product.stock === 0 ? "opacity-50 cursor-not-allowed" : "hover:bg-black hover:text-white"}
            `}
          >
          ...
          <Link
            to={`/product/${product.slug}`}
            className="px-4 py-2 text-sm rounded-full backdrop-blur bg-black text-white font-medium shadow-lg hover:opacity-80 transition"
          >
            View
          </Link>
